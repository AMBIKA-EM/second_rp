...
title_lb=tk.Label(head_frame,text='Automobile DataEntry',bg='#158aff' 
...
rt.title('Automobile DataEntry')
canvas=Canvas(rt,width=700,height=500)
#canvas.place(x=20,y=500)
canvas.pack(side=LEFT, padx=250,pady=90)
my_image=PhotoImage(file='C:\\Users\\ambik\\AMBIKA\\Tkinter\\images\\mitsubishi_calendar_screenshot.gif')
canvas.create_image(0,0,anchor =NW ,image=my_image)
'''l=Label(rt,text="" ,font=("courier",50),fg="purple")
l.place(x=40,y=25)'''
...
label2=Label(rt, text="Search Car" ,font=("courier", 15))
label2.place(x=520,y=100)

combobox=Combobox(rt,values=['Audi','BMW','Honda',
